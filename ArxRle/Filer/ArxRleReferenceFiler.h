...
#ifndef ARXRLEREFERENCEFILER_H
#define ARXRLEREFERENCEFILER_H

/****************************************************************************
**
**      CLASS ArxRleReferenceFiler:
**
**      **jma
**
*************************************/

class ArxRleReferenceFiler: public AcDbDwgFiler {

public:
    ACRX_DECLARE_MEMBERS(ArxRleReferenceFiler);

                        ArxRleReferenceFiler() {}
    virtual             ~ArxRleReferenceFiler() {}
