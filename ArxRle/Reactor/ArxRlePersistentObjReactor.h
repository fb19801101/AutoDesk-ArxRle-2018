...
#ifndef ARXRLEPERSISTENTOBJREACTOR_H
#define ARXRLEPERSISTENTOBJREACTOR_H


/****************************************************************************
**
**	CLASS ArxRlePersistentObjReactor:
**
**	**jma
**
*************************************/
...
class ArxRlePersistentObjReactor : public AcDbObject {

public:
    ACRX_DECLARE_MEMBERS(ArxRlePersistentObjReactor);

        // constructors/destructors
					ArxRlePersistentObjReactor()	{}
    virtual			~ArxRlePersistentObjReactor()	{}
...
private:
    ...
    static Adesk::Int16 m_version;
        ...
        // outlawed functions
    ArxRlePersistentObjReactor(const ArxRlePersistentObjReactor &copy);
    ArxRlePersistentObjReactor&	operator=(const ArxRlePersistentObjReactor &copy);        

};

#endif    // ARXRLEPERSISTENTOBJREACTOR_H
