...
#ifndef ARXRLEEDINPUTCONTEXTREACTOR_H
#define ARXRLEEDINPUTCONTEXTREACTOR_H

/****************************************************************************
**
**  CLASS ArxRleEdInputContextReactor:
**
**  **jma
**
*************************************/

class ArxRleEdInputContextReactor : public AcEdInputContextReactor {

public:
					ArxRleEdInputContextReactor();
    virtual			~ArxRleEdInputContextReactor();
...
private:
	...
	bool	printDetails();
        ...
        // outlawed functions
    ArxRleEdInputContextReactor(const ArxRleEdInputContextReactor &copy);
    ArxRleEdInputContextReactor&	operator=(const ArxRleEdInputContextReactor &copy);        
};


#endif    // ARXRLEEDINPUTCONTEXTREACTOR_H
