...
#ifndef ARXRLEEDITORREACTOR_H
#define ARXRLEEDITORREACTOR_H

/****************************************************************************
**
**  CLASS ArxRleEditorReactor:
**
**  **jma
**
*************************************/

class ArxRleEditorReactor : public AcEditorReactor2 {

public:
    ACRX_DECLARE_MEMBERS(ArxRleEditorReactor);

        // constructor/destructors
                    ArxRleEditorReactor();
    virtual         ~ArxRleEditorReactor();
...
private:
    ...
    LPCTSTR    undoActivityToStr(int activity, CString& str);
        ...
        // outlawed functions
    ArxRleEditorReactor(const ArxRleEditorReactor &copy);
    ArxRleEditorReactor&	operator=(const ArxRleEditorReactor &copy);        
};

#endif    // ARXRLEEDITORREACTOR_H
