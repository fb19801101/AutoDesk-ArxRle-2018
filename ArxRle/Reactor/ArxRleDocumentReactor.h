...
#ifndef ARXRLEDOCUMENTREACTOR_H
#define ARXRLEDOCUMENTREACTOR_H

/****************************************************************************
**
**  CLASS ArxRleDocumentReactor:
**
**  **jma
**
*************************************/

class ArxRleDocumentReactor : public AcApDocManagerReactor {

public:
    ACRX_DECLARE_MEMBERS(ArxRleDocumentReactor);

        // constructor/destructors
                    ArxRleDocumentReactor();
    virtual         ~ArxRleDocumentReactor();
...
private:
    ...
    void		printReactorMessage(LPCTSTR event) const;
        ...
        // outlawed functions
    ArxRleDocumentReactor(const ArxRleDocumentReactor &copy);
    ArxRleDocumentReactor&  operator=(const ArxRleDocumentReactor &copy);        
};

#endif    // ARXRLEDOCUMENTREACTOR_H
