...
#ifndef ARXRLETRANSACTIONREACTOR_H
#define ARXRLETRANSACTIONREACTOR_H

/****************************************************************************
**
**	CLASS ArxRleTransactionReactor:
**
**	**jma
**
*************************************/

class ArxRleTransactionReactor : public AcTransactionReactor {

public:
    ACRX_DECLARE_MEMBERS(ArxRleTransactionReactor);

        // constructors/destructor
					ArxRleTransactionReactor();
    virtual			~ArxRleTransactionReactor();
...
private:
	...
	void	printReactorMessage(LPCTSTR event, const AcDbObject* obj1,
        ...
        // outlawed functions
    ArxRleTransactionReactor(const ArxRleTransactionReactor &copy);
    ArxRleTransactionReactor&    operator=(const ArxRleTransactionReactor &copy);        
};


#endif    // ARXRLETRANSACTIONREACTOR_H
