...
#ifndef ARXRLEEVENTREACTOR_H
#define ARXRLEEVENTREACTOR_H

/****************************************************************************
**
**  CLASS ArxRleEventReactor:
**
**  **jma
**
*************************************/

class ArxRleEventReactor : public AcRxEventReactor {

public:
    ACRX_DECLARE_MEMBERS(ArxRleEventReactor);

                    ArxRleEventReactor();
    virtual         ~ArxRleEventReactor();
...
private:
    ...
    // outlawed functions
    ArxRleEventReactor(const ArxRleEventReactor &copy);
    ArxRleEventReactor&	operator=(const ArxRleEventReactor &copy);        
};

#endif    // ARXRLEEVENTREACTOR_H
