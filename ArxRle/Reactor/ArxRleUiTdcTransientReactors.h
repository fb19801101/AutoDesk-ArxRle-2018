...
#ifndef ARXRLEUITDCTRANSIENTREACTORS_H
#define ARXRLEUITDCTRANSIENTREACTORS_H
...
class ArxRleUiTdcTransientReactors : public ArxRleUiTdcObjReactorsBase {

friend class ArxRleUiTdmReactors;

public:
                    ArxRleUiTdcTransientReactors();
    virtual         ~ArxRleUiTdcTransientReactors()    {}

    //{{AFX_DATA(ArxRleUiTdcTransientReactors)
...
private:
	...
	static ArxRleTransientObjReactor*     m_objReactor;
	static ArxRleTransientEntReactor*     m_entReactor;
...
#endif // ARXRLEUITDCTRANSIENTREACTORS_H
