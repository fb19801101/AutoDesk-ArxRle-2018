...
#ifndef ARXRLE_VIEWPORTDRAW_H
#define ARXRLE_VIEWPORTDRAW_H

#include "ArxRleWorldDraw.h"

class ArxRleGiViewportGeometry;

/******************************************************************************
**
**    CLASS ArxRleGiViewportDraw:
**
**    **jma
**
****************************/

class ArxRleGiViewportDraw : public AcGiViewportDraw {

public:
    ACRX_DECLARE_MEMBERS(ArxRleGiViewportDraw);

                        ArxRleGiViewportDraw();
    virtual                ~ArxRleGiViewportDraw();
...
private:
    ArxRleGiViewportGeometry*    m_geom;
...
class ArxRleGiViewportGeometry : public AcGiViewportGeometry {

public:

    ACRX_DECLARE_MEMBERS(ArxRleGiViewportGeometry);

                    ArxRleGiViewportGeometry()        {}
    virtual            ~ArxRleGiViewportGeometry()    {}
