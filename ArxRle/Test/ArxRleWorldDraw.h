...
#ifndef ARXRLE_WORLDDRAW_H
#define ARXRLE_WORLDDRAW_H

class ArxRleGiWorldGeometry;
class ArxRleGiSubEntityTraits;

/******************************************************************************
**
**  CLASS ArxRleGiContext:
**
**  **jma
**
****************************/

class ArxRleGiContext : public AcGiContext {

public:
    ACRX_DECLARE_MEMBERS(ArxRleGiContext);
...
/******************************************************************************
**
**  CLASS ArxRleGiCommonDraw:
**
**  **jma
**
****************************/

class ArxRleGiWorldDraw : public AcGiWorldDraw {

public:
    ACRX_DECLARE_MEMBERS(ArxRleGiWorldDraw);

                        ArxRleGiWorldDraw();
    virtual             ~ArxRleGiWorldDraw();
...
private:
    ArxRleGiWorldGeometry*      m_geom;
    ArxRleGiSubEntityTraits*    m_traits;
    ArxRleGiContext*            m_context;
...
class ArxRleGiWorldGeometry : public AcGiWorldGeometry {

public:

    ACRX_DECLARE_MEMBERS(ArxRleGiWorldGeometry);

                    ArxRleGiWorldGeometry()     {}
    virtual         ~ArxRleGiWorldGeometry()    {}
...
class ArxRleGiSubEntityTraits : public AcGiSubEntityTraits {

public:
    ACRX_DECLARE_MEMBERS(ArxRleGiSubEntityTraits);

                    ArxRleGiSubEntityTraits()   {}
    virtual         ~ArxRleGiSubEntityTraits()  {}
