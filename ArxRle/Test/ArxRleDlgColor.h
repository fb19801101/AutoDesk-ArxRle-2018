...
#ifndef ARXRLEDLGCOLOR_H
#define ARXRLEDLGCOLOR_H
...
class ArxRleDlgColor : public CDialog {

public:
                ArxRleDlgColor(CWnd* pParent);
    virtual        ~ArxRleDlgColor();
