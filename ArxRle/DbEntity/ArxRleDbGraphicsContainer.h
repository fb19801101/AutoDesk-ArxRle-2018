...
/****************************************************************************
**
**  CLASS ArxRleDbGraphicsContainer:
...
class ArxRleDbGraphicsContainer: public ArxRleDbEntity {

public:
						ArxRleDbGraphicsContainer();
	virtual				~ArxRleDbGraphicsContainer();

    ACDB_DECLARE_MEMBERS(ArxRleDbGraphicsContainer);
