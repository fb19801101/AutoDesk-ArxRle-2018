...
ACRX_DXF_DEFINE_MEMBERS(ArxRleDbDictRecord, AcDbObject,
						AcDb::kDHL_1015, AcDb::kMRelease0,
						0, ARXRLE_DICT_RECORD, ArxRle)

/****************************************************************************
**
**  ArxRleDbDictRecord::ArxRleDbDictRecord
**
**  **jma
**
*************************************/
...
/****************************************************************************
**
**  ArxRleDbDictRecord::description
**
**  **jma
**
*************************************/
...
const TCHAR*
ArxRleDbDictRecord::description() const
{
    assertReadEnabled();
...
/****************************************************************************
**
**  ArxRleDbDictRecord::setDescription
**
**  **jma
**
*************************************/
...
void
ArxRleDbDictRecord::setDescription(const TCHAR* val)
{
...
Acad::ErrorStatus
ArxRleDbDictRecord::getName(CString& name) const
{
    assertReadEnabled();
...
/****************************************************************************
**
**  ArxRleDbDictRecord::dwgInFields
**
**  **jma
**
*************************************/
...
Acad::ErrorStatus
ArxRleDbDictRecord::dwgInFields(AcDbDwgFiler* filer)
{
...
/****************************************************************************
**
**  ArxRleDbDictRecord::dwgOutFields
**
**  **jma
**
*************************************/
...
Acad::ErrorStatus
ArxRleDbDictRecord::dwgOutFields(AcDbDwgFiler* filer) const
{
	if (ArxRleOptions::m_instance.m_showDwgFilerMessages) {
		CString str, str2;
		acutPrintf(_T("\n%s <DwgOut : %s>"),
				ArxRleUtils::objToClassAndHandleStr(const_cast<ArxRleDbDictRecord*>(this), str),
				ArxRleUtils::filerTypeToStr(filer->filerType(), str2));
	}
...
/****************************************************************************
**
**  ArxRleDbDictRecord::dxfInFields
**
**  **jma
**
*************************************/
...
Acad::ErrorStatus
ArxRleDbDictRecord::dxfInFields(AcDbDxfFiler* filer)
{
    assertWriteEnabled();
    Acad::ErrorStatus es;
...
/****************************************************************************
**
**  ArxRleDbDictRecord::dxfOutFields
**
**  **jma
**
*************************************/
...
Acad::ErrorStatus
ArxRleDbDictRecord::dxfOutFields(AcDbDxfFiler* filer) const
{
    assertReadEnabled();
    Acad::ErrorStatus es;
...
/****************************************************************************
**
**  ArxRleDbDictRecord::mangleNameForXref
**
**  **jma
**
*************************************/
...
bool
ArxRleDbDictRecord::mangleNameForXref(CString& name, AcDbDatabase* db, AcDbDictionary* pDict) const
{
...
/****************************************************************************
**
**  ArxRleDbDictRecord::mangleNameForRefEdit
**
**  **jma
**
*************************************/
...
bool
ArxRleDbDictRecord::mangleNameForRefEdit(CString& name, AcDbDictionary* pDict) const
{
...
/****************************************************************************
**
**  ArxRleDbDictRecord::unMangleNameForRefEdit
**
...
bool
ArxRleDbDictRecord::unMangleNameForRefEdit(CString& name) const
{
    int namePos;
    int nameLen;
...
/****************************************************************************
**
**  ArxRleDbDictRecord::isDictInNOD
...
bool
ArxRleDbDictRecord::isDictInNOD(const AcDbObjectId& dictId, const AcDbObjectId& entryId,
                      AcDbDatabase* db,
...
/****************************************************************************
**
**  ArxRleDbDictRecord::wblockClone
**
**  **jma
**
*************************************/
...
Acad::ErrorStatus
ArxRleDbDictRecord::subWblockClone(AcRxObject* pOwner,
							...
							Adesk::Boolean isPrimary) const
{
    ...
    if (pDestDb) {
		pDestDict = ArxRleUtils::openDictionaryForWrite(dictName, true, pDestDb);
        if (pDestDict == NULL)
