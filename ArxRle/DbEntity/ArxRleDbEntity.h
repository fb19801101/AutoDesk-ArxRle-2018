...
#ifndef ARXRLEDBENTITY_H
#define ARXRLEDBENTITY_H

/****************************************************************************
**
**  CLASS ArxRleDbEntity:
...
**	to other entities.  See ArxRleDbAdeskLogo.cpp
...
class ArxRleDbEntity : public AcDbEntity {
...
public:
	...
	enum CloneRefType {
		...
		kFakeClone	= 2,	// Add to IdMap, but don't actually clone
                ...
                ArxRleDbEntity();
    virtual     ~ArxRleDbEntity();

    ACRX_DECLARE_MEMBERS(ArxRleDbEntity);
