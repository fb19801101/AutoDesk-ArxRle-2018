...
#ifndef ARXRLEDBDICTRECORD_H
#define ARXRLEDBDICTRECORD_H


/****************************************************************************
**
**	CLASS ArxRleDbDictRecord:
...
**  of the necessary code resides in ArxRleAppEditorReactor.cpp because you must
**	rely on AcRxEventReactor or AcEdReactor functions to get the work done.
**	See ArxRleDbAdeskLogoStyle as an example of a working derived object.
**
**	**jma
**
*************************************/

class ArxRleDbDictRecord : public AcDbObject {

public:
                ArxRleDbDictRecord();
    virtual     ~ArxRleDbDictRecord();

    ACRX_DECLARE_MEMBERS(ArxRleDbDictRecord);
