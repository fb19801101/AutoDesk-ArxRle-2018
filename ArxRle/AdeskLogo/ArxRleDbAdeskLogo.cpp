...
Adesk::Int16     ArxRleDbAdeskLogo::m_version = 0;     // MDI safe

ACRX_DXF_DEFINE_MEMBERS(ArxRleDbAdeskLogo, ArxRleDbEntity,
						AcDb::kDHL_1015, AcDb::kMRelease0,
						0, ARXRLE_ADESK_LOGO, ArxRle)

/****************************************************************************
**
**  ArxRleArxRleDbArxRleDbAdeskLogo::ArxRleDbAdeskLogo
**
**  **jma
**
*************************************/

ArxRleDbAdeskLogo::ArxRleDbAdeskLogo()
{
    m_tmpMtext = NULL;
...
Acad::ErrorStatus
ArxRleDbAdeskLogo::setScale(const AcGeScale3d& newScale)
{
...
AcDbObjectId
ArxRleDbAdeskLogo::logoStyleId() const
{
    assertReadEnabled();
...
/****************************************************************************
**
**  ArxRleDbAdeskLogo::setLogoStyleId
**
**  **jma
**
*************************************/
...
Acad::ErrorStatus
ArxRleDbAdeskLogo::setLogoStyleId(const AcDbObjectId& styleId)
{
...
/****************************************************************************
**
**  ArxRleDbAdeskLogo::arbitraryReferenceId
**
**  **jma
**
*************************************/
...
AcDbObjectId
ArxRleDbAdeskLogo::arbitraryReferenceId() const
{
    assertReadEnabled();
...
/****************************************************************************
**
**  ArxRleDbAdeskLogo::setArbitraryReferenceId
**
**  **jma
**
*************************************/
...
Acad::ErrorStatus
ArxRleDbAdeskLogo::setArbitraryReferenceId(const AcDbObjectId& refEntId)
{
...
/****************************************************************************
**
**  ArxRleDbAdeskLogo::getCloneReferences
...
void
ArxRleDbAdeskLogo::getCloneReferences(AcDb::DeepCloneType type,
...
/****************************************************************************
**
**  ArxRleDbAdeskLogo::verifyReferences
...
Acad::ErrorStatus
ArxRleDbAdeskLogo::verifyReferences(int& fixedErrorCount, bool fullCheck)
{
    Acad::ErrorStatus es = ArxRleDbEntity::verifyReferences(fixedErrorCount, fullCheck);
    if (es != Acad::eOk)
        return es;
    ...
    es = ArxRleUtils::verifyEntityReference(this, m_arbitraryRefEnt, NULL, true, false);
    if (es != Acad::eOk) {
			// print this out just for educational purposes.
		acutPrintf(_T("\nArxRleDbAdeskLogo: severed stale reference"));
...
Acad::ErrorStatus
ArxRleDbAdeskLogo::dwgInFields(AcDbDwgFiler* filer)
{
    Acad::ErrorStatus es;
    if ((es = ArxRleDbEntity::dwgInFields(filer)) != Acad::eOk)
        return es;
...
/****************************************************************************
**
**  ArxRleDbAdeskLogo::dwgOutFields
**
**  **jma
**
*************************************/
...
Acad::ErrorStatus
ArxRleDbAdeskLogo::dwgOutFields(AcDbDwgFiler* filer) const
{
    Acad::ErrorStatus es;
    if ((es = ArxRleDbEntity::dwgOutFields(filer)) != Acad::eOk)
        return es;
...
Acad::ErrorStatus
ArxRleDbAdeskLogo::dxfInFields(AcDbDxfFiler* filer)
{
    Acad::ErrorStatus es;
    if (((es = ArxRleDbEntity::dxfInFields(filer)) != Acad::eOk) ||
...
/****************************************************************************
**
**  ArxRleDbAdeskLogo::dxfOutFields
**
**  **jma
**
*************************************/
...
Acad::ErrorStatus
ArxRleDbAdeskLogo::dxfOutFields(AcDbDxfFiler* filer) const
{
    Acad::ErrorStatus es;
    if ((es = ArxRleDbEntity::dxfOutFields(filer)) != Acad::eOk)
        return es;
...
/****************************************************************************
**
**  ArxRleDbAdeskLogo::subWorldDraw
**
**  **jma
**
*************************************/
...
Adesk::Boolean
ArxRleDbAdeskLogo::subWorldDraw(AcGiWorldDraw* worldDraw)
{
...
/****************************************************************************
**
**  ArxRleDbAdeskLogo::subViewportDraw
**
**  **jma
**
*************************************/
...
void
ArxRleDbAdeskLogo::subViewportDraw(AcGiViewportDraw* vportDraw)
{
...
void
ArxRleDbAdeskLogo::commonDraw(AcGiCommonDraw* drawContext)
{
    ...
    ArxRleDbAdeskLogoStyle* lStyle = NULL;
...
/****************************************************************************
**
**  ArxRleDbAdeskLogo::drawSingleCaliper
...
void
ArxRleDbAdeskLogo::drawSingleCaliper(AcGiCommonDraw* drawContext, AcGePoint3d* pts,
                                   ArxRleDbAdeskLogoStyle* lStyle)
{
...
void
ArxRleDbAdeskLogo::drawLogo(AcGiCommonDraw* drawContext, ArxRleDbAdeskLogoStyle* lStyle)
{
    AcGePoint3d pts[5];

        // NOTE: we can just hardwire these points around the origin in
        // a 1 x 1 unit block scheme because our ECS data from the ArxRleDbEntity
...
void
ArxRleDbAdeskLogo::drawLabel(AcGiCommonDraw* drawContext, ArxRleDbAdeskLogoStyle* lStyle)
{
...
void
ArxRleDbAdeskLogo::drawBorder(AcGiCommonDraw* drawContext, ArxRleDbAdeskLogoStyle* lStyle)
{
    AcGePoint3d pts[5];
...
void
ArxRleDbAdeskLogo::drawRefLine(AcGiCommonDraw* drawContext)
{
	AcDbEntity* ent;
...
/****************************************************************************
**
**  ArxRleDbAdeskLogo::getReferenceAttachmentPoint
...
void
ArxRleDbAdeskLogo::getReferenceAttachmentPoint(AcDbEntity* ent, AcGePoint3d& toPt)
{
	AcDbCircle* circ;
	AcDbArc* arc;
	AcDbLine* line;
...
/****************************************************************************
**
**  ArxRleDbAdeskLogo::subSetDatabaseDefaults
...
void
ArxRleDbAdeskLogo::subSetDatabaseDefaults(AcDbDatabase* pDb)
{
    ASSERT(pDb != NULL);
    ...
    ArxRleDbEntity::subSetDatabaseDefaults(pDb);      // let parent class do its thing

        // if style is still NULL, set it to the standard style from
        // this database.
    if (m_logoStyleId == AcDbObjectId::kNull) {
        assertWriteEnabled();
		m_logoStyleId = ArxRleDbAdeskLogoStyle::getStandardStyle(pDb, true);
    }
}

/****************************************************************************
**
**  ArxRleDbAdeskLogo::audit
**
**  **jma
**
*************************************/
...
Acad::ErrorStatus
ArxRleDbAdeskLogo::audit(AcDbAuditInfo* pAuditInfo)
{
    Acad::ErrorStatus es = ArxRleDbEntity::audit(pAuditInfo);
...
void
ArxRleDbAdeskLogo::subList() const
{
	ArxRleDbEntity::subList();

	CString str;

	AcGeScale3d sc = scale();
	printForListCmd(_T("Scale X"), ArxRleUtils::doubleToStr(sc.sx, str));
	printForListCmd(_T("Scale Y"), ArxRleUtils::doubleToStr(sc.sy, str));
	printForListCmd(_T("Scale Z"), ArxRleUtils::doubleToStr(sc.sz, str));

	ArxRleDbAdeskLogoStyle* style;
	...
	printForListCmd(_T("Arbitrary Reference"), ArxRleUtils::objToClassAndHandleStr(m_arbitraryRefEnt, str));
}

/****************************************************************************
**
**  ArxRleDbAdeskLogo::transformBy
**
**  **jma
**
*************************************/
...
Acad::ErrorStatus
ArxRleDbAdeskLogo::subTransformBy(const AcGeMatrix3d& xform)
{
    assertWriteEnabled();
