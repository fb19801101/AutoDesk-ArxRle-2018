...
#ifndef ARXRLEDBADESKLOGO_H
#define ARXRLEDBADESKLOGO_H

#include "DbEntity/ArxRleDbEntity.h"

class ArxRleDbAdeskLogoStyle;

/****************************************************************************
**
**  CLASS ArxRleDbAdeskLogo:
...
class ArxRleDbAdeskLogo : public ArxRleDbEntity {

public:
                ArxRleDbAdeskLogo();
    virtual     ~ArxRleDbAdeskLogo();

    ACRX_DECLARE_MEMBERS(ArxRleDbAdeskLogo);
...
protected:
    ...
    virtual void        drawSingleCaliper(AcGiCommonDraw* drawContext, AcGePoint3d* pts, ArxRleDbAdeskLogoStyle* lStyle);
    virtual void        drawLogo(AcGiCommonDraw* drawContext, ArxRleDbAdeskLogoStyle* lStyle);
    virtual void        drawLabel(AcGiCommonDraw* drawContext, ArxRleDbAdeskLogoStyle* lStyle);
    virtual void        drawBorder(AcGiCommonDraw* drawContext, ArxRleDbAdeskLogoStyle* lStyle);
