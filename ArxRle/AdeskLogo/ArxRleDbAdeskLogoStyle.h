...
#ifndef ARXRLEDBADESKLOGOSTYLE_H
#define ARXRLEDBADESKLOGOSTYLE_H
...
class ArxRleDbAdeskLogoStyle : public ArxRleDbDictRecord {

public:
                ArxRleDbAdeskLogoStyle();
    virtual     ~ArxRleDbAdeskLogoStyle();

    ACRX_DECLARE_MEMBERS(ArxRleDbAdeskLogoStyle);
...
#endif    // ARXRLEDBADESKLOGOSTYLE_H
