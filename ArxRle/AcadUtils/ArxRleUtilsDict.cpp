...
/****************************************************************************
**
**	ArxRleUtils::getRegularDictionaryId
...
AcDbObjectId
ArxRleUtils::getRegularDictionaryId(LPCTSTR dictName, bool createIfNotFound, AcDbDatabase* db)
{
	ASSERT(db != NULL);
...
/****************************************************************************
**
**  ArxRleUtils::getSubDictionaryId
**
**  **jma
**
*************************************/
...
AcDbObjectId
ArxRleUtils::getSubDictionaryId(LPCTSTR dictName, bool createIfNotFound,
...
/****************************************************************************
**
**	ArxRleUtils::openDictionaryForRead
...
AcDbDictionary*
ArxRleUtils::openDictionaryForRead(LPCTSTR dictName, AcDbDatabase* db)
{
	ASSERT(db != NULL);
...
AcDbDictionary*
ArxRleUtils::openDictionaryForRead(LPCTSTR dictName, const AcDbObjectId& parentDictId)
{
...
AcDbDictionary*
ArxRleUtils::openDictionaryForRead(LPCTSTR dictName, AcDbDictionary* parentDict)
{
    ASSERT(dictName != NULL);
    ASSERT(parentDict != NULL);
...
/****************************************************************************
**
**	ArxRleUtils::openDictionaryForWrite
...
AcDbDictionary*
ArxRleUtils::openDictionaryForWrite(LPCTSTR dictName, bool createIfNotFound, AcDbDatabase* db)
{
	ASSERT(db != NULL);
...
AcDbDictionary*
ArxRleUtils::openDictionaryForWrite(LPCTSTR dictName, bool createIfNotFound, const AcDbObjectId& parentDictId)
{
    ASSERT(dictName != NULL);
    if (parentDictId == AcDbObjectId::kNull)
        return NULL;
...
AcDbDictionary*
ArxRleUtils::openDictionaryForWrite(LPCTSTR dictName, bool createIfNotFound,
                                            AcDbDictionary* parentDict)
{
    ASSERT(dictName != NULL);
    ASSERT(parentDict != NULL);
    ...
    if (es == Acad::eOk) {
        ...
        if (createIfNotFound) {
            ...
            if (es != Acad::eOk) {
                acutPrintf(_T("\nERROR: could not create dictionary \"%s\" (%s)"), dictName, ArxRleUtils::rxErrorStr(es));
                delete dict;
                dict = NULL;
            }
        }
...
/****************************************************************************
**
**	ArxRleUtils::collectDictionaryEntryNames
...
Acad::ErrorStatus
ArxRleUtils::collectDictionaryEntryNames(const AcDbObjectId& dictId, ArxRleSdStrObjIdList& list, AcRxClass* classType)
{
...
/****************************************************************************
**
**	ArxRleUtils::lookUpDictEntryName
...
bool
ArxRleUtils::lookUpDictEntryName(const AcDbObjectId& objId, CString& entryName)
{
    bool retCode = FALSE;
    AcDbObject* obj;
...
/****************************************************************************
**
**	ArxRleUtils::openExtDictForRead
**
**	**jma
**
*************************************/
...
AcDbDictionary*
ArxRleUtils::openExtDictForRead(const AcDbObject* obj)
{
    ASSERT(obj != NULL);
...
/****************************************************************************
**
**	ArxRleUtils::openExtDictForWrite
...
AcDbDictionary*
ArxRleUtils::openExtDictForWrite(AcDbObject* obj, bool createIfNotFound)
{
    ASSERT(obj != NULL);
