...
#ifndef ARXRLESELSET_H
#define ARXRLESELSET_H
...
private:
    ...
    void            setFlags(bool hasPrompts);
        ...
        // outlawed functions (move these up when implemented)
                    ArxRleSelSet(const ArxRleSelSet&);
    ArxRleSelSet&	operator=(const ArxRleSelSet&);
};


#endif    // ARXRLESELSET_H
