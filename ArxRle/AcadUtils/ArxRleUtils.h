...
#ifndef ARXRLE_UTILS_H
#define ARXRLE_UTILS_H
...
static ArxRleUiPrBase::Status    yesNoPrompt(LPCTSTR msg, bool& answer);
static ArxRleUiPrBase::Status    yesNoPromptDef(LPCTSTR msg, bool& answer, bool def);
static ArxRleUiPrBase::Status    getNewSymbolName(LPCTSTR msg, AcRxClass* symType, CString& symName);
static ArxRleUiPrBase::Status    getExistingSymbolName(LPCTSTR msg, AcRxClass* symType,
...
static void    fillListBox(const ArxRleSdStrList& slist, CListBox& lb, int defIndex = 0);
static void    fillListBox(const ArxRleSdStrObjIdList& slist, CListBox& lb, int defIndex = 0);
static void    fillListBox(const ArxRleSdStrObjIdList& slist, CComboBox& cb, int defIndex = 0);
...
static Acad::ErrorStatus	collectDictionaryEntryNames(const AcDbObjectId& dictId, ArxRleSdStrObjIdList& list, AcRxClass* classType);
...
static Acad::ErrorStatus	collectBlockIds(ArxRleSdStrObjIdList& list, bool excludeMsPs,
											bool excludeXref,
