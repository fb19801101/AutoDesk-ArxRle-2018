...
bool
ArxRleRbList::addToEmptyList(resbuf* newNode)
{
    ASSERT(newNode != NULL);
...
ArxRleRbList::ArxRleRbList(resbuf* adoptedList)
{
    m_head = adoptedList;
...
ArxRleRbList::ArxRleRbList(const ArxRleRbList& copyFrom)
{
...
ArxRleRbList&
ArxRleRbList::operator=(const ArxRleRbList& copyFrom)
{
...
void
ArxRleRbList::addHead(resbuf* newNode)
{
    ASSERT(newNode != NULL);
...
void
ArxRleRbList::addTail(resbuf* newNode)
{
    ASSERT(newNode != NULL);
...
void
ArxRleRbList::append(ArxRleRbList& appendList)
{
...
void
ArxRleRbList::adoptData(resbuf* adoptedList)
{
...
resbuf*
ArxRleRbList::detach(resbuf* nodeToDel)
{
...
resbuf*
ArxRleRbList::detach(resbuf* startPtr, resbuf* endPtr)
{
    ASSERT(m_head != NULL);
...
void
ArxRleRbList::remove(resbuf* nodeToDel)
{
