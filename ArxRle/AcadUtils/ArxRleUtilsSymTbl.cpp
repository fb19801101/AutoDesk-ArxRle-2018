...
Acad::ErrorStatus
ArxRleUtils::symbolIdToName(const AcDbObjectId& symbolId, CString& name)
{
...
/****************************************************************************
**
**	ArxRleUtils::mlineStyleIdToName
...
Acad::ErrorStatus
ArxRleUtils::mlineStyleIdToName(const AcDbObjectId& mlineStyleId, CString& name)
{
        // get symbol name from symbol table record
...
Acad::ErrorStatus
ArxRleUtils::nameToSymbolId(AcRxClass* symTblClass, LPCTSTR name,
...
bool
ArxRleUtils::symbolExists(AcRxClass* symTblClass, LPCTSTR name, AcDbDatabase* db)
{
	ASSERT(symTblClass != NULL);
	ASSERT(db != NULL);
...
AcDbSymbolTable*
ArxRleUtils::openSymbolTable(AcRxClass* symTblClass,
...
Acad::ErrorStatus
ArxRleUtils::collectSymbolIds(AcRxClass* symTblClass,
...
Acad::ErrorStatus
ArxRleUtils::collectBlockIds(ArxRleSdStrObjIdList& list, bool excludeMsPs,
...
/****************************************************************************
**
**	ArxRleUtils::addNewSymbolAndClose
...
Acad::ErrorStatus
ArxRleUtils::addNewSymbolAndClose(AcDbSymbolTable* symTbl,
...
Acad::ErrorStatus
ArxRleUtils::addNewLayer(LPCTSTR layerName, AcDbDatabase* db)
{
	ASSERT(db != NULL);
...
Acad::ErrorStatus
ArxRleUtils::defineNewBlock(LPCTSTR blkName, AcDbBlockTableRecord*& newBlkRec,
...
Acad::ErrorStatus
ArxRleUtils::defineNewBlock(LPCTSTR blkName, AcDbObjectId& newBlkRecId, AcDbDatabase* db)
{
...
/****************************************************************************
**
**	ArxRleUtils::defineNewAnonymousBlock
**
**	**jma
**
*************************************/
...
Acad::ErrorStatus
ArxRleUtils::defineNewAnonymousBlock(AcDbBlockTableRecord*& newBlkRec,
                                AcDbObjectId& newBlkRecId, AcDbDatabase* db)
{
	ASSERT(db != NULL);
...
Acad::ErrorStatus
ArxRleUtils::defineNewAnonymousBlock(AcDbBlockTableRecord*& newBlkRec, AcDbDatabase* db)
{
    AcDbObjectId newBlkRecId;
...
Acad::ErrorStatus
ArxRleUtils::defineNewAnonymousBlock(AcDbObjectId& newBlkRecId, AcDbDatabase* db)
{
    AcDbBlockTableRecord* newBlkRec;
...
Acad::ErrorStatus
ArxRleUtils::openBlockDef(LPCTSTR blkName, AcDbBlockTableRecord*& blkRec,
                                    AcDb::OpenMode mode, AcDbDatabase* db)
{
    ASSERT(blkName != NULL);
	ASSERT(db != NULL);
    ...
    if (es != Acad::eKeyNotFound)
        ArxRleUtils::rxErrorMsg(es);        // print error message if its an unexpected error
...
/****************************************************************************
**
**	ArxRleUtils::openCurrentSpaceBlock
**
**	**jma
**
*************************************/
...
ArxRleUtils::openCurrentSpaceBlock(AcDb::OpenMode mode, AcDbDatabase* db)
{
	ASSERT(db != NULL);
...
Acad::ErrorStatus
ArxRleUtils::addToCurrentSpace(AcDbEntity* newEnt)
{
...
Acad::ErrorStatus
ArxRleUtils::addToCurrentSpace(AcDbEntity* newEnt, AcDbDatabase* db)
{
    ASSERT(newEnt != NULL);
	ASSERT(db != NULL);
    ...
    if (es != Acad::eOk) {
        acutPrintf(_T("\nERROR: could not add entity to current space (%s)"), ArxRleUtils::rxErrorStr(es));
    }
...
/****************************************************************************
**
**  ArxRleUtils::addToCurrentSpaceAndClose
**      add a new entity to the current space block record.
**
...
Acad::ErrorStatus
ArxRleUtils::addToCurrentSpaceAndClose(AcDbEntity* newEnt, AcDbDatabase* db)
{
    Acad::ErrorStatus es;
...
Acad::ErrorStatus
ArxRleUtils::addToCurrentSpaceAndClose(AcDbEntity* newEnt)
{
...
bool
ArxRleUtils::isOnLockedLayer(AcDbObjectId& id, bool printMsg)
{
    AcDbEntity* ent;
...
bool
ArxRleUtils::isOnLockedLayer(AcDbEntity* ent, bool printMsg)
{
    AcDbObject* obj;
