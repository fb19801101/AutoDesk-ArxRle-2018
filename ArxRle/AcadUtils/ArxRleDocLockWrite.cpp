...
/****************************************************************************
**
**  ArxRleDocLockWrite::ArxRleDocLockWrite
**
**  **jma
**
*************************************/
...
ArxRleDocLockWrite::ArxRleDocLockWrite(AcDbDatabase* db)
:   m_didLock(false),
    m_didSwitch(false),
    m_db(db)
{
...
/****************************************************************************
**
**  ArxRleDocLockWrite::lockAndSetCurrent
**
**  **jma
**
*************************************/
...
Acad::ErrorStatus
ArxRleDocLockWrite::lock(AcDbDatabase* nextDb)
{
	ASSERT(nextDb != NULL);
...
Acad::ErrorStatus
ArxRleDocLockWrite::lockAndSetCurrent(AcDbDatabase* nextDb)
{
	ASSERT(nextDb != NULL);
...
/****************************************************************************
**
**  ArxRleDocLockWrite::unlockAndRestoreCurrent
**
**  **jma
**
*************************************/
