...
#include "ArxRleUiPrDoubleDef.h"



/****************************************************************************
**
**  ArxRleUiPrDoubleDef::ArxRleUiPrDoubleDef
**
**  **jma
**
*************************************/

ArxRleUiPrDoubleDef::ArxRleUiPrDoubleDef(LPCTSTR msg, LPCTSTR keyWordList, DoubleType type, double def)
:   ArxRleUiPrDouble(msg, keyWordList, type)
{
    m_default = def;
}
