...
#ifndef ARXRLEUITDCDBOBJECTBASE_H
#define ARXRLEUITDCDBOBJECTBASE_H
...
/****************************************************************************
**
**	CLASS ArxRleUiTdcDbObjectBase:
**
**	**jma
**
*************************************/

class ArxRleUiTdcDbObjectBase : public ArxRleUiTdcRxObjectBase {

public:
    virtual    ~ArxRleUiTdcDbObjectBase()    {}

    //{{AFX_DATA(ArxRleUiTdcDbObjectBase)
    //}}AFX_DATA

    // ClassWizard generated virtual function overrides
    //{{AFX_VIRTUAL(ArxRleUiTdcDbObjectBase)
    public:
...
protected:
            ArxRleUiTdcDbObjectBase();    // can only be constructed by derived classes

    // Generated message map functions
    //{{AFX_MSG(ArxRleUiTdcDbObjectBase)
...
#endif    // ARXRLEUITDCDBOBJECTBASE_H
