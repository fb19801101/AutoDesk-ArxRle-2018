...
#ifndef ARXRLEUIDLGOBJSTATE_H
#define ARXRLEUIDLGOBJSTATE_H
...
class ArxRleUiDlgObjState : public CAcUiDialog {

public:
                ArxRleUiDlgObjState(CWnd* parent, const AcDbObjectId& objId, LPCTSTR dboxTitle = NULL);
                ArxRleUiDlgObjState(CWnd* parent, AcDbObject* obj, LPCTSTR dboxTitle = NULL);
    virtual     ~ArxRleUiDlgObjState();

    //{{AFX_DATA(ArxRleUiDlgObjState)
    enum { IDD = ARXRLE_DLG_RXSTATE };
    //}}AFX_DATA


    //{{AFX_VIRTUAL(ArxRleUiDlgObjState)
    protected:
    virtual void DoDataExchange(CDataExchange* pDX);    // DDX/DDV support
    //}}AFX_VIRTUAL

protected:
    //{{AFX_MSG(ArxRleUiDlgObjState)
