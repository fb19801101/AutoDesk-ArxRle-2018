...
#ifndef ARXRLEUITDCSYMTBL_H
#define ARXRLEUITDCSYMTBL_H
...
class ArxRleUiTdcSymTbl : public ArxRleUiTdcDbObjectBase {

public:
                ArxRleUiTdcSymTbl(AcDbDatabase* db);
    virtual		~ArxRleUiTdcSymTbl()    {}

    //{{AFX_DATA(ArxRleUiTdcSymTbl)
    enum { IDD = ARXRLE_TDC_SYMTBLS };
